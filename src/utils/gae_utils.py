'''
https://github.com/DaehanKim/vgae_pytorch/blob/master/preprocessing.py
...
def mask_test_edges(adj, seed=42):
    ...
    ''' -------- processing val-test idxs --------'''
    all_edge_idx = list(range(edges.shape[0]))
    random_state.shuffle(all_edge_idx)
    ...
    while len(test_edges_false) < len(test_edges):
        idx_i = random_state.randint(0, adj.shape[0])
        idx_j = random_state.randint(0, adj.shape[0])
        if idx_i == idx_j:
            continue
